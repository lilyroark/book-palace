...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="<?=$this->base_url?>/index.php?page=book&command=add_review&book=<?=$isbn?>">
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="mb-3">
              ...
              <input type="text" name="rating" class="form-control" id="rating" placeholder="1-5"
                >
