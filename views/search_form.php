      ...
      echo "
          <div class='card col-4 mb-2' style='width: 18rem;'>
            <div class='card-body'>
              ...
              <b style='float:right'>favorite</b></h5>
              ...
              <button  class='badge btn btn-dark' onclick='addCheckout(this, {$book["available_count"]})'  style='float:right'  copies = {$book["available_count"]} value=".$book['isbn'].">
              <b style='float:right'>checkout</b>
              </div>
          </div>
      ";
    }
